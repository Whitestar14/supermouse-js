...
import { CalligraphyPlugin } from "./calligraphy-plugin";
import { SmartRing, SmartIcon, TextRing, Sparkles } from "@supermousejs/labs";

/**
 * CALLIGRAPHY PLUGIN (Raw Interface)
 * Optimized for performance and frame-independent physics.
 */
...
<template>
  ...
  >
    ...
    <main class="flex-1 relative flex flex-col overflow-hidden">
      ...
      >
        <div class="flex items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <span class="text-[10px] font-mono font-bold uppercase tracking-[0.2em] text-white"
              >Lab_System_v2</span
            >
          </div>
          <div class="h-4 w-[1px] bg-zinc-800" />
          <span class="text-[10px] font-mono text-zinc-500 uppercase">Buffer: 128ms</span>
        </div>
        <div class="flex items-center gap-6">
          <div class="flex flex-col items-end text-right">
            <span class="text-[9px] font-mono text-zinc-600 uppercase leading-none">Status</span>
            <span class="text-[10px] font-mono text-emerald-400 font-bold uppercase leading-tight"
              >Operational</span
            >
          </div>
          <div class="flex flex-col items-end text-right">
            <span class="text-[9px] font-mono text-zinc-600 uppercase leading-none">Sync</span>
            <span class="text-[10px] font-mono text-white font-bold uppercase leading-tight"
              >{{ fps }} FPS</span
            >
          </div>
        </div>
      ...
      <!-- TEST GRID -->
      <div class="flex-1 overflow-y-auto p-6 md:p-12 relative z-10 custom-scrollbar">
        <div class="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              ...
              >
                <span class="text-xs text-zinc-500 group-hover:text-white transition-colors"
            ...
            >
              <span
                class="absolute top-4 left-4 text-[9px] font-mono text-zinc-600 uppercase tracking-widest"
                >04 / Calligraphy_Ink</span
              >
              <div class="text-center p-6 border border-zinc-800/50 bg-zinc-950/50">
                <div class="text-[10px] font-mono mb-2 text-zinc-600">Trace the area</div>
                <div class="text-xs uppercase font-bold tracking-[0.2em] text-amber-500">
                  Physics Flow
                </div>
              </div>
            </div>
    ...
    <!-- SIDEBAR -->
    <aside class="w-80 border-l border-zinc-900 bg-black flex flex-col shrink-0 relative z-40">
      <div class="p-8 border-b border-zinc-900">
        <h2 class="text-xs font-bold text-white uppercase tracking-[0.3em] mb-2">Registry</h2>
        ...
        >
          ...
          >
            <div
              ...
              :class="enabled ? 'bg-amber-500 translate-x-3' : 'bg-zinc-800 translate-x-0'"
            />
          </div>
        </div>
      </div>
      ...
      <div class="p-6 border-t border-zinc-900 bg-black">
        <div class="text-[9px] font-mono text-zinc-600 uppercase tracking-widest mb-4">
          Output Log
        </div>
        <div class="space-y-1 font-mono text-[9px] text-zinc-500">
          ...
          <div class="flex justify-between">
            ...
            <span class="text-emerald-500">12/12</span>
          </div>
          <div class="flex justify-between">
