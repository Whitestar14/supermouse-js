...
const diagnostics = [
  ...
  },
  {
    ...
    signal:
      "Cursor freezes or disappears at the edge of a YouTube embed or map.",
  ...
  <DocsSection label="Guide" title="Troubleshooting">
    ...
    <div class="border-t border-l border-zinc-200 bg-zinc-200 gap-px grid">
      ...
      >
        <!-- Left: Signal (Span 4) -->
        <div
          class="lg:col-span-4 p-6 md:p-8 flex flex-col gap-4 border-b border-r border-zinc-200"
        >
          <div class="flex items-center justify-between">
            <span
              class="mono text-[10px] font-bold uppercase tracking-widest text-zinc-400"
            >
              {{ item.id }} / {{ item.type }}
            </span>
          </div>
