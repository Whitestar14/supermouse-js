...
<template>
  ...
  >
    <p class="text-lg text-zinc-600 mb-12 leading-relaxed">
      Supermouse is a modular cursor engine with a plugin-first architecture. Contributions are
      welcome, but not required to participate in the ecosystem. This document explains
      <span class="text-black font-bold border-b-2 border-black/10">how to contribute</span>,
      <span class="text-black font-bold border-b-2 border-black/10">what belongs in this repo</span>, and
      <span class="text-black font-bold border-b-2 border-black/10">how does the toolchain work</span>.
    </p>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-200 border border-zinc-200 mb-12">
      ...
      <div class="bg-white p-8">
        ...
        <ul class="space-y-3 text-sm text-zinc-700">
          ...
          <li class="flex gap-3">
            <span class="text-zinc-900 font-bold">✓</span>
            <span><strong>Reference-quality</strong> plugins that demonstrate an essential
              pattern</span>
          </li>
        </ul>
      </div>
    ...
    <ul class="space-y-4 text-zinc-600 mb-8 list-none pl-0 text-sm">
      ...
      <li class="flex gap-3">
        <span class="w-1.5 h-1.5 bg-black rounded-full mt-2 shrink-0" />
        <span>Cursor logic is <strong>hot-path code</strong>. Allocations and layout reads are
          scrutinized.</span>
      </li>
    </ul>
    ...
    <div class="border-t border-zinc-200 pt-12 mb-16">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        ...
        <div class="p-6 border border-zinc-200">
          ...
          <p class="text-sm text-zinc-600 leading-relaxed">
            <code>@changesets/cli</code> manages semver bumping and changelog generation based on
            PRs.
          </p>
        </div>
      </div>
