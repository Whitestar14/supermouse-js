...
import { AUTHOR, YEAR, GITHUB_URL, TWITTER_URL } from '../constants';
</script>
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="flex-1 px-6 py-8 md:p-12 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div class="flex gap-6 text-zinc-400">
             <!-- Twitter/X -->
             <a :href="TWITTER_URL" target="_blank" rel="noopener noreferrer" class="hover:text-black transition-colors">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
             </a>
             <!-- Github -->
             <a :href="GITHUB_URL" target="_blank" rel="noopener noreferrer" class="hover:text-black transition-colors">
