...
<template>
  <footer class="border-t border-zinc-200 bg-white">
    <div class="flex flex-col md:flex-row">
      <!-- Left Gutter -->
      <div
        class="hidden md:block w-[96px] border-r border-zinc-200 shrink-0"
      ></div>
      ...
      >
        <div class="flex items-center gap-4">
          <div
            class="flex items-baseline text-lg font-bold tracking-tighter text-zinc-300"
          >
          ...
          <span
            class="mono text-xs text-zinc-400 uppercase tracking-widest font-bold"
          >
