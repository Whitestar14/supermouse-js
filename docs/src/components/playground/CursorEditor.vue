...
<template>
  <Teleport to="body">
    ...
    <div
      v-if="activeRecipeId"
      class="fixed inset-0 z-[100] bg-white/95 flex items-center justify-center p-0 md:p-8"
    >
      <div
            ...
            <div class="absolute top-8 left-8 z-30 hidden lg:block pointer-events-none select-none">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p class="text-[10px] uppercase tracking-widest text-zinc-400 font-bold mt-1">
                    Interactive Preview
                  </p>
                </div>
              </div>
