    ...
    <div class="flex flex-col lg:flex-row border-b border-zinc-200">
      ...
      <div class="flex-1 flex flex-col lg:flex-row">
        ...
        <div class="flex-1 px-6 py-12 md:p-16 lg:p-24 bg-white relative z-10">
          <div class="max-w-2xl">
            <h3
              class="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter text-zinc-900 mb-6 md:mb-8 leading-[1.05]"
            >
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              ...
              <router-link
                to="/docs/plugins/dot"
                class="inline-flex h-12 items-center justify-center px-6 border border-zinc-200 text-zinc-900 font-bold text-sm hover:bg-zinc-50 transition-colors"
              >
                Browse Ecosystem
              </router-link>
            </div>
