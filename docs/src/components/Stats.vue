          ...
          <div class="flex-1 relative flex flex-col p-8 md:p-16 lg:p-24">
             <div class="relative z-10 max-w-3xl">
                ...
                <div class="flex gap-8 mt-12">
                   <div>
                      <div class="text-4xl font-bold font-mono text-purple-600">2.4M</div>
                   ...
                   <div>
                      <div class="text-4xl font-bold font-mono text-purple-600">14ms</div>
                ...
                <svg class="w-full h-full" preserveAspectRatio="none" viewBox="0 0 1000 300">
                   <defs>
                      <linearGradient id="grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                        <stop offset="0%" stop-color="rgb(147, 51, 234)" stop-opacity="0.2" />
                   ...
                   <path d="M0,250 L50,260 L100,240 L150,280 L200,220 L250,230 L300,180 L350,200 L400,150 L450,160 L500,120 L550,140 L600,100 L650,110 L700,50 L750,70 L800,20 L850,40 L900,10 L950,5 L1000,0" 
                         fill="none" stroke="#9333ea" stroke-width="3" vector-effect="non-scaling-stroke" />
                </svg>
             </div>
          </div>
       </div>
