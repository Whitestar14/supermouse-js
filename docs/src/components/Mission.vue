...
<template>
  <section class="relative">
    ...
    >
      ...
      <!-- Text Content -->
      <div
        class="flex-1 px-6 py-12 md:p-16 lg:p-24 border-b lg:border-b-0 lg:border-r border-zinc-200 bg-white relative z-10"
      >
        <h2
          class="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tighter text-zinc-900 mb-8 text-pretty leading-[1.1]"
        >
          The Mission
        </h2>
        <div
