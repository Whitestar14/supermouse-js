    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-200 border border-zinc-200 mb-12">
      ...
      <div class="bg-zinc-50 p-8">
        ...
        <div class="mt-8 pt-6 border-t border-zinc-200 text-xs text-zinc-500">
          These belong as
          <NuxtLink to="/docs/advanced/authoring" class="underline hover:text-black font-bold">
            external plugins </NuxtLink
          >.
        </div>
      </div>
    </div>
    ...
    <ul class="space-y-4 text-zinc-600 mb-8 list-none pl-0 text-sm">
      ...
      <li class="flex gap-3">
        ...
        <Text size="sm">
          ...
          <NuxtLink to="/docs/advanced/architecture" class="underline font-bold hover:text-black"
            >Core Architecture</NuxtLink
          >
