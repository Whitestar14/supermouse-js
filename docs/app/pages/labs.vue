...
import type { PresetRecipe } from "@/components/playground/recipes/types";
  ...
  <div class="text-zinc-900 relative min-h-screen bg-white">
    ...
    <div class="flex flex-col min-h-[calc(100vh-80px)]">
      ...
      <div class="sticky top-0 z-30 flex bg-white border-b border-zinc-200 h-16 md:h-20">
        <div
          class="w-[80px] md:w-[96px] border-r border-zinc-200 shrink-0 flex items-center justify-center bg-white"
        />
        <div
      ...
      <div class="flex flex-col lg:flex-row flex-1 items-stretch">
        ...
        <div class="flex-1 bg-white min-h-[50vh]">
          <div
            ...
            class="grid grid-cols-1 md:grid-cols-2 gap-px bg-zinc-200 border-b border-zinc-200"
          >
            <button
            ...
            >
              ...
              <div class="mt-auto relative z-10">
                <div class="flex justify-between items-end mb-2">
                  <h3
                    class="text-lg font-bold text-zinc-900 tracking-tight group-hover:translate-x-1 transition-transform"
                  >
                    {{ preset.name }}
                  </h3>
                </div>
                <p class="text-xs text-zinc-500 font-mono leading-relaxed max-w-[90%] line-clamp-2">
                  {{ preset.description }}
                </p>
              </div>
            </button>
