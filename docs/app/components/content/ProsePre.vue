...
/**
 * Markdown code fences are highlighted with the same local highlighter as
 ...
 *
 * The shell is theme-adaptive: `bg-code-surface` resolves to a light paper tone
 * in light mode and a lifted near-black in dark mode (see `index.css`).
 */
...
<template>
  <div class="group relative my-6" :class="props.class">
    ...
    >
      ...
      <button
        type="button"
        class="flex h-7 w-7 items-center justify-center border border-code-border bg-surface/80 text-code-muted backdrop-blur-sm transition-colors hover:text-strong"
